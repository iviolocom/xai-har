...
if __name__ == "__main__":
    ...
    for k in range(16):
        video_ids={}
        video_names = []
        video_ids_file = os.path.join(path, 'video_ids_rs' + str(k) +'.csv')
        ...
        checkpoint_right_list = ['checkpoint_submit/checkpoint_epoch_right_10013_81.99_96.27.pyth',
                             'checkpoint_submit/checkpoint_epoch_right_20017_74.38_96.25.pyth',
                             'checkpoint_submit/checkpoint_epoch_right_30015_81.41_96.15.pyth',
                             'checkpoint_submit/checkpoint_epoch_right_40014_80.62_98.12.pyth',
                             'checkpoint_submit/checkpoint_epoch_right_50015_85.12_98.81.pyth'] 
        vid_info = dict(sorted(vid_info.items()))
        prob_1, video_order = main(cfg, vid_info, labels, filelist, checkpoint_right_list)
