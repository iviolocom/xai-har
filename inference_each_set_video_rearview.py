...
#!/usr/bin/env python3
# python inference_each_set_video_rearview.py --cfg configs/Kinetics/X3D_L.yaml NUM_GPUS 1 TRAIN.ENABLE False DATA.PATH_TO_DATA_DIR datasets22
...
if __name__ == "__main__":
    ...
    for k in range(16):
        video_ids={}
        video_names = []
        video_ids_file = os.path.join(path, 'video_ids_rv' + str(k) +'.csv')
        ...
        checkpoint_rearview_list = ['checkpoint_submit/checkpoint_epoch_rearview_10016_85.71_97.52.pyth',
                                'checkpoint_submit/checkpoint_epoch_rearview_20013_75.00_96.25.pyth',
                                'checkpoint_submit/checkpoint_epoch_rearview_30012_81.25_97.50.pyth',
                                'checkpoint_submit/checkpoint_epoch_rearview_40016_80.62_96.88.pyth',
                                'checkpoint_submit/checkpoint_epoch_rearview_50016_83.93_97.62.pyth'] 
        vid_info = dict(sorted(vid_info.items()))
        prob_1, video_order = main(cfg, vid_info, labels, filelist, checkpoint_rearview_list)
