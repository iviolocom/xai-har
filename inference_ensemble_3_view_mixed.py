...
if __name__ == "__main__":
    ...
    checkpoint_dashboard_list = ['checkpoint_submit/checkpoint_epoch_dashboard_10015_79.79_98.96.pyth',
                                 'checkpoint_submit/checkpoint_epoch_dashboard_20017_68.06_96.34.pyth',
                                 'checkpoint_submit/checkpoint_epoch_dashboard_30017_73.96_94.79.pyth',
                                 'checkpoint_submit/checkpoint_epoch_dashboard_40017_74.48_96.88.pyth',
                                 'checkpoint_submit/checkpoint_epoch_dashboard_50017_77_97.pyth']  
    ...
    for key in (video_ids.keys() | filelist.keys()):
        ...
        if key in filelist: vid_info.setdefault(key, []).append(filelist[key])
    vid_info = dict(sorted(vid_info.items()))
    checkpoint_rearview_list = ['checkpoint_submit/checkpoint_epoch_rearview_10015_79.79_97.93.pyth',
                                'checkpoint_submit/checkpoint_epoch_rearview_20018_69.11_94.24.pyth',
                                'checkpoint_submit/checkpoint_epoch_rearview_30017_77.60_94.27.pyth',
                                'checkpoint_submit/checkpoint_epoch_rearview_40014_68.23_93.75.pyth',
                                'checkpoint_submit/checkpoint_epoch_rearview_50015_81.00_98.00.pyth'] 
    ...
    for key in (video_ids.keys() | filelist.keys()):
        ...
        if key in filelist: vid_info.setdefault(key, []).append(filelist[key])
    vid_info = dict(sorted(vid_info.items()))
    checkpoint_right_list = ['checkpoint_submit/checkpoint_epoch_right_10014_74.61_97.41.pyth',
                             'checkpoint_submit/checkpoint_epoch_right_20015_68.06_95.81.pyth',
                             'checkpoint_submit/checkpoint_epoch_right_30018_73.94_96.28.pyth',
                             'checkpoint_submit/checkpoint_epoch_right_40014_68.23_93.23.pyth',
                             'checkpoint_submit/checkpoint_epoch_right_50018_73.50_96.pyth'] 
